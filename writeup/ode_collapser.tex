...
I selected 6 systems (ODEs) and for each ODE I selected 2 or 3 sets of initial conditions.
I constructed the solution of each ODE and initial condition pair (either by knowledge of the analytical solution or using PySR's numerical integrator), and sampled a timeseries of 10 points from each, adding Gaussian noise with $\sigma = 0.1$.%
\footnote{
